  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DataTable2(
        ...
        headingRowColor: WidgetStateProperty.resolveWith((states) => PColors.primary),
        // Set the decoration for the data table
        decoration: const BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.all(Radius.circular(PSizes.borderRadiusMd)),
        ),
        // Set the decoration for the heading row of the data table
        headingRowDecoration: const BoxDecoration(
          borderRadius: BorderRadius.only(topLeft: Radius.circular(PSizes.borderRadiusMd), topRight: Radius.circular(PSizes.borderRadiusMd)),
        ),
      ),
    );
  }
