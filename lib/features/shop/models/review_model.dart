...
class ReviewModel {
  ...
  final Map<String, String>? selectedVariation; // Thêm biến thể được chọn
  ...
  ReviewModel({
    ...
    this.selectedVariation, // Thêm tham số này
  });

  // Chuyển đổi từ ReviewModel sang Map để lưu vào Firestore
  Map<String, dynamic> toJson() {
    return {
      ...
      'datetime': datetime,
      'orderId': orderId,
      'selectedVariation': selectedVariation, // Thêm trường này
    };
  }

  // Tạo ReviewModel từ DocumentSnapshot của Firestore
